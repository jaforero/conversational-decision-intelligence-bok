...
|---|---|---|---|
| Portal bilingüe | [`v0.8.1`](v0.8.1.md) | Estable editorial y técnicamente | Rutas ES/EN completas, interfaz localizada y gates contra deriva de traducción |
