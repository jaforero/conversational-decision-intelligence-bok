...
| Portal técnico | `v0.3.0-rc.1` | Desplegado | MkDocs, navegación, CI/CD, checks y dominio personalizado |
| Núcleo fundacional | `v0.4.0-rc.1` | Candidate | Constitución, fronteras CDI, glosario, dominios y especificación PULSE |
...
!!! note "Por qué no existe un v0.1.0 posterior"
    La hoja de ruta inicial nombró la salida de Sprint 2 como `v0.1.0`, pero la secuencia ya había publicado `v0.2.0` y `v0.3.0-rc.1`. ADR-014 preserva el linaje y asigna `v0.4.0-rc.1` al núcleo fundacional.
